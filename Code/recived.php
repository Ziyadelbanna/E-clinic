	...
	<div class="navbar navbar-default navbar-fixed-top ">
		...
		<div style='overflow: auto;' class="container" id="bgImage">
			...
			<div id="mailBoxContent">
				...
				<table class="table table-hover tableText centered">
					<?php
					...
					$sent_query= "SELECT content,subject,time FROM messages WHERE reciver='$surname'";
			...
			if($sent_counter==0){
				?>
				<span class="error"><h2> There Are No Recived E_Mails </h2></span><br><br>
				<?php
			}
	if($sent_counter>0){
  	...
  	echo"      ";
  	print "<td><strong>Content</strong></td></tr>"."<br><br>";
